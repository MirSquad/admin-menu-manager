...
function wpa_mm_register_ability_category() {
	wp_register_ability_category( 'admin-menu-manager', array(
...
function wpa_mm_register_abilities() {
	...
	wp_register_ability( 'admin-menu-manager/get-config', array(
		...
		'execute_callback'    => function( $input = null ) {
			$config = (array) get_option( 'wpa_mm_config', array( 'items' => array(), 'groups' => array() ) );
			if ( ! isset( $config['items'] ) )  $config['items']  = array();
			if ( ! isset( $config['groups'] ) ) $config['groups'] = array();
			return $config;
		},
		'meta' => array(
	...
	wp_register_ability( 'admin-menu-manager/reset-config', array(
